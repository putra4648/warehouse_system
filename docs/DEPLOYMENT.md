...
| `OKTA_OAUTH2_ISSUER` | Auth0/Okta Issuer URI | `https://your-domain.au.auth0.com/` |
| `OKTA_OAUTH2_AUDIENCE` | Auth0 API Audience | `your-audience` |
...
4. Verify environment variables are set correctly (especially Auth0 credentials).
...
export OKTA_OAUTH2_ISSUER=your-issuer
